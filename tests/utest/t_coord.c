...
void utest1(void) {
    ...
    assert(fabs(pos[0] + PI / 2) < 1E-6 && pos[2] > 0.0);
    ecef2pos(r6, pos);
    assert(fabs(pos[0] * R2D - 3.1796021375E+01) < 1E-7 && fabs(pos[1] * R2D - 1.3040799917E+02) < 1E-7 &&
...
void utest3(void) {
    ...
    ecef2enu(pos2, r4, e);
    assert(fabs(e[0] + 0.499254) < 1E-6 && fabs(e[1] - 0.393916) < 1E-6 && fabs(e[2] - 0.309152) < 1E-6);
    enu2ecef(pos2, e, r);
    assert(fabs(r[0] - r4[0]) < 1E-6 && fabs(r[1] - r4[1]) < 1E-6 && fabs(r[2] - r4[2]) < 1E-6);
