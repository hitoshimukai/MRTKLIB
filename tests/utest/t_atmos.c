...
void utest1(void) {
    ...
    double ion1[] = {0.2E-7, -0.8e-8, -0.5e-7, 0.1e-6, 0.2E+6, 0.2e+6, -0.1e+6, -0.1e+7};
    double ion2[] = {0.2E-7, -0.8e-8, -0.5e-7, 0.1e-6, 0.2E+6, 0.2e+6, -0.1e+6, -0.1e+7};
...
/* ionmapf() */
void utest2(void) { printf("%s utest2 : OK\n", __FILE__); }
/* tropmodel */
void utest3(void) {
    gtime_t time = {0};
    double pos1[] = {35 * D2R, 140 * D2R, 100.0};
