...
void utest1(void) {
    ...
    assert(fabs(a - 0.0) < 1E-15);
    a = str2num(s1, 0, 3);
    assert(fabs(a - 123.0) < 1E-13);
    a = str2num(s1, 10, 6);
    assert(fabs(a - 123456.0) < 1E-10);
    a = str2num(s1, 28, 10);
    assert(fabs(a - 90.0) < 1E-14);
    a = str2num(s2, 4, 4);
...
void utest2(void) {
    ...
    s = str2time(s1, 0, 0, &t);
    assert(s < 0);
    s = str2time(s1, 30, 10, &t);
    assert(s < 0);
    s = str2time(s1, 10, 0, &t);
    assert(s < 0);
    s = str2time(s1, -1, 10, &t);
    assert(s < 0);
    s = str2time(s1, 4, 17, &t);
    time2epoch(t, ep);
    assert(!s && ep[0] == 2004 && ep[1] == 1 && ep[2] == 1 && ep[3] == 0 && ep[4] == 1 && fabs(ep[5] - 2.34) < 1E-15);
    s = str2time(s2, 4, 21, &t);
    time2epoch(t, ep);
    assert(!s && ep[0] == 2000 && ep[1] == 2 && ep[2] == 3 && ep[3] == 23 && ep[4] == 59 &&
           fabs(ep[5] - 59.999) < 1E-14);
    s = str2time(s3, 4, 20, &t);
    time2epoch(t, ep);
    assert(!s && ep[0] == 1980 && ep[1] == 10 && ep[2] == 30 && ep[3] == 6 && ep[4] == 58 && ep[5] == 9);
    s = str2time(s4, 4, 20, &t);
    time2epoch(t, ep);
...
void utest3(void) {
    ...
    t = epoch2time(ep3);
    time2epoch(t, ep);
    assert(ep[0] == 2004 && ep[1] == 12 && ep[2] == 31 && ep[3] == 23 && ep[4] == 59 &&
           fabs(ep[5] - 59.999999) < 1E-14);
    t = epoch2time(ep4);
    time2epoch(t, ep);
    ...
    t = epoch2time(ep6);
    time2epoch(t, ep);
    assert(ep[0] == 2099 && ep[1] == 12 && ep[2] == 31 && ep[3] == 23 && ep[4] == 59 &&
           fabs(ep[5] - 59.999999) < 1E-14);
#endif
...
void utest7(void) {
    ...
    gtime_t t;
    double ep[6];
    t = gpst2utc(epoch2time(ep0));
    time2epoch(t, ep);
    assert(ep[0] == 1980 && ep[1] == 1 && ep[2] == 6 && ep[3] == 0 && ep[4] == 0 && ep[5] == 0.0);
    t = gpst2utc(epoch2time(ep1));
    time2epoch(t, ep);
    assert(ep[0] == 1992 && ep[1] == 6 && ep[2] == 30 && ep[3] == 23 && ep[4] == 59 && fabs(ep[5] - 59.999999) < 1E-14);
    t = gpst2utc(epoch2time(ep2));
    time2epoch(t, ep);
    assert(ep[0] == 1992 && ep[1] == 7 && ep[2] == 1 && ep[3] == 0 && ep[4] == 0 && ep[5] == 0.0);
    t = gpst2utc(epoch2time(ep3));
    time2epoch(t, ep);
    assert(ep[0] == 1992 && ep[1] == 7 && ep[2] == 1 && ep[3] == 0 && ep[4] == 0 && ep[5] == 0.0);
    t = gpst2utc(epoch2time(ep4));
    time2epoch(t, ep);
    assert(ep[0] == 2004 && ep[1] == 12 && ep[2] == 31 && ep[3] == 23 && ep[4] == 59 &&
           fabs(ep[5] - 46.999999) < 1E-14);
    t = gpst2utc(epoch2time(ep5));
    time2epoch(t, ep);
    assert(ep[0] == 2005 && ep[1] == 12 && ep[2] == 31 && ep[3] == 23 && ep[4] == 59 && ep[5] == 47.0);
    t = gpst2utc(epoch2time(ep6));
    time2epoch(t, ep);
...
void utest8(void) {
    ...
    while (t0.time < t1.time) {
        t2 = utc2gpst(t0);
        t3 = gpst2utc(t2);
        assert(t0.time == t3.time && t0.sec == t3.sec);
        t0.time += 86400.0;
    }
