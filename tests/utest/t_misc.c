...
void utest4(void) {
    ...
    vu = getbitu(buff, 0, 8);
    assert(vu == 1);
    setbitu(buff, 4, 8, 255);
    vu = getbitu(buff, 4, 8);
    assert(vu == 255);
    setbitu(buff, 13, 8, 1);
    vu = getbitu(buff, 13, 8);
    assert(vu == 1);
    setbitu(buff, 29, 8, 255);
    vu = getbitu(buff, 29, 8);
    assert(vu == 255);
    setbitu(buff, 99, 10, 1023);
    vu = getbitu(buff, 99, 10);
    assert(vu == 1023);
    setbitu(buff, 666, 31, 123456);
    vu = getbitu(buff, 666, 31);
    assert(vu == 123456);
    setbitu(buff, 777, 32, 789012);
    vu = getbitu(buff, 777, 32);
    assert(vu == 789012);

    setbits(buff, 100, 8, 1);
    vs = getbitu(buff, 100, 8);
    assert(vs == 1);
    setbits(buff, 104, 8, 127);
    vs = getbitu(buff, 104, 8);
    assert(vs == 127);
    setbits(buff, 113, 8, 1);
    vs = getbitu(buff, 113, 8);
    assert(vs == 1);
    setbits(buff, 129, 8, 127);
    vs = getbitu(buff, 129, 8);
    assert(vs == 127);
    setbits(buff, 199, 10, 511);
    vs = getbitu(buff, 199, 10);
    assert(vs == 511);
    setbits(buff, 766, 31, 123456);
    vs = getbitu(buff, 766, 31);
    assert(vs == 123456);
    setbits(buff, 877, 32, 789012);
    vs = getbitu(buff, 877, 32);
    assert(vs == 789012);

    setbits(buff, 200, 8, -1);
    vs = getbits(buff, 200, 8);
    assert(vs == -1);
    setbits(buff, 204, 8, -127);
    vs = getbits(buff, 204, 8);
    assert(vs == -127);
    setbits(buff, 213, 8, -3);
    vu = getbits(buff, 213, 8);
    assert(vu == -3);
    setbits(buff, 229, 8, -126);
    vu = getbits(buff, 229, 8);
    assert(vu == -126);
    setbits(buff, 299, 24, -99999);
    vu = getbits(buff, 299, 24);
    assert(vu == -99999);
    setbits(buff, 866, 31, -12345);
    vs = getbits(buff, 866, 31);
    assert(vs == -12345);
    setbits(buff, 977, 32, -67890);
    vs = getbits(buff, 977, 32);
    assert(vs == -67890);
