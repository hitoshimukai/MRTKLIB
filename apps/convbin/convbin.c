...
static const char* help[] = {
    "mrtk convert: convert receiver binary log to RINEX (convbin)",
    "",
    "Usage: mrtk convert [OPTIONS] FILE",
    "",
    "  Convert RTCM, receiver raw-data logs, and RINEX files to RINEX OBS/NAV",
    "  and SBAS/LEX message files (RTKLIB SBAS/LEX message format).",
    "  Supported inputs:",
    "",
    ...
    "  -ts, --start Y/M/D H:M:S   Start time                            [all]",
    "  -te, --end   Y/M/D H:M:S   End time                              [all]",
    "  -tr  Y/M/D H:M:S           Approximated time for RTCM",
    "  -ti, --interval SEC        Observation data interval (s)         [all]",
    "  -tt  TTOL                  Observation epoch tolerance (s)       [0.005]",
    "  -span H                    Time span (h)                         [all]",
    "  -r   FORMAT                Log format type:",
    "                               rtcm2  rtcm3  nov  oem3  ubx  ss2",
    "                               hemis  stq    javad nvs binex rt17 sbf  rinex",
    "  -ro  OPT                   Receiver-dependent options",
    "  -f,  --freq N              Number of frequencies                 [5]",
    ...
    "  -ho  OBSERVER              RINEX header: observer/agency (sep '/')",
    "  -hr  REC                   RINEX header: receiver no/type/ver (sep '/')",
    "  -ha  ANT                   RINEX header: antenna no/type (sep '/')",
    "  -hp  POS                   RINEX header: approx position x/y/z (sep '/')",
    "  -hd  DELTA                 RINEX header: antenna delta h/e/n (sep '/')",
    "  -v   VER                   RINEX version                         [3.04]",
    "  -od                        Include doppler in RINEX OBS          [on]",
    "  -os                        Include SNR in RINEX OBS              [on]",
    "  -oi                        Include iono correction in NAV header [off]",
    "  -ot                        Include time correction in NAV header [off]",
    "  -ol                        Include leap seconds in NAV header    [off]",
    "  -halfc                     Half-cycle ambiguity correction       [off]",
    "  -mask  SIG[,...]           Signal mask (sig={G|R|E|J|S|C|I}L{1C|1P|...})",
    "  -nomask SIG[,...]          Signal no-mask (same syntax as -mask)",
    "  -x   SAT                   Exclude satellite",
    "  -y   SYS                   Exclude system (G/R/E/J/S/C/I)",
    "  -d   DIR                   Output directory                      [input dir]",
    "  -c   STAID                 Use RINEX file name convention        [off]",
    "  -o,  --output OFILE        Output RINEX OBS file",
    "  -n,  --nav    NFILE        Output RINEX NAV file",
    "  -g   GFILE                 Output RINEX GNAV file",
    "  -h   HFILE                 Output RINEX HNAV file (NOT a help flag)",
    ...
    "  -trace, --trace LEVEL      Trace level                           [off]",
    "  --help                     Show this help",
    "                               (-h is the HNAV output flag, not help)",
    "",
    "  If no output file is specified, defaults are used: <file>.obs, <file>.nav,",
    "  <file>.gnav, <file>.hnav, <file>.qnav, <file>.lnav, <file>.cnav,",
    "  <file>.inav, <file>.sbs. For RTCM input use -tr to set the approximate log",
    "  start time; otherwise the week number comes from the time-tag file or the",
    "  log's last-modified time.",
    "",
    "  If the receiver type is not given, it is inferred from the file extension:",
    "    *.rtcm2 *.rtcm3 *.gps *.ubx *.log *.bin *.stq *.jps *.bnx *.binex",
    "    *.rt17 *.sbf *.obs *.*o *.rnx *.nav *.*n",
    "",
    "Examples:",
    "  mrtk convert --start 2024/01/15 00:00:00 -r ubx -o out.obs raw.ubx",
    "  mrtk convert -r sbf --interval 1 --output rover.obs --nav rover.nav rover.sbf",
    NULL,
};
/* print help ----------------------------------------------------------------*/
